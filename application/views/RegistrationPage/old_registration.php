					...
					<div class="row clearfix">
						...
						<div class="col-md-5 column">
							...
							<div class="form-group ">
								<table  id="example" class="table table-responsive table-hover" class="display" style="width:100%">
									<thead>
										<tr>
											<th>Patient ID</th>
											<th>Name</th>
									...
									<tbody>
										<?php foreach ($records6 as $r): ?>
										<tr>
											<td class="align-middle"><input type="radio" name='patientid'  value="<?php echo $r->patient_id; ?>" ><?php echo $r->patient_id; ?></td>
...
<div class="container">
	...
	<div class="container">
		...
		<script scr="https://cdn.datatables.net/fixedheader/3.1.5/js/dataTables.fixedHeader.min.js"></script> -->
